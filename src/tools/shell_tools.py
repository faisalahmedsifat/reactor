...
def analyze_command_error(
    ...
    if "command not found" in error_lower or "is not recognized as an internal or external command" in error_lower:
    ...
    elif "no such file" in error_lower or "does not exist" in error_lower or "cannot find path" in error_lower:
